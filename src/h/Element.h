...
//!	Constructor
	CElement() : NEN_(0), nodes_(nullptr), ElementMaterial_(nullptr), thickness(0.0), LocationMatrix_(nullptr), ND_(0) {}
...
//! Virtual deconstructor
    virtual ~CElement() {
        ...
        // ElementMaterial_ is a pointer to a material object owned by CElementGroup.
        // CElement should not delete it. CElementGroup is responsible for its lifecycle.
        // if (ElementMaterial_)
        //     delete [] ElementMaterial_; // DO NOT DELETE THIS - CAUSES DOUBLE FREE
...
//!	Return number of stress/strain values to be outputted
    virtual unsigned int GetNumberOfStressStrainOutputs() const = 0;
