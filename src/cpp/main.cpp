...
//      Calculate and output stresses of all elements
    ...
    // Write legacy VTK file for post-processing
    *Output << "\n> Generating VTK file for post-processing..." << endl;
    string vtk_filename = filename + ".vtk";
    Output->WriteLegacyVTKFile(vtk_filename);
    *Output << "> VTK file \"" << vtk_filename << "\" generated successfully." << endl;
